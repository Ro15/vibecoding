...
from app.core import engine  # noqa: F401  (imports register all rules)
from app.core.models import NormalizedResource
from app.core.rules.idle_vms import evaluate_idle_vms
from app.core.rules.old_snapshots import evaluate_old_snapshots
from app.core.rules.orphaned_ips import evaluate_orphaned_ips
from app.core.rules.unattached_disks import evaluate_unattached_disks
